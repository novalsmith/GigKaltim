...
<h3 style="border-bottom:dashed 1px #AAB2BD">Edit Hotel
<small>
...
<i class="icon  icon-arrow-left icon-white"></i> Kembali</a>
   ...
   <?php 
            ...
            echo   form_open('hotel/proses_update_hotel', $data);
            ?>
...
<?php 
         $gambar    = array(
            ...
            echo form_hidden('id_info_hotel',$edit->id_info_hotel);
            echo img('asset/upload/hotel/gambarkecil/'.$edit->gambar_kecil_hotel);
              echo form_hidden('g_besar', $edit->gambar_besar_hotel);
              echo form_hidden('g_kecil', $edit->gambar_kecil_hotel);
...
echo form_textarea('ket_hotel',$edit->keterangan_hotel);
