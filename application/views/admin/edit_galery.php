...
<i class="icon  icon-arrow-left icon-white"></i> Kembali</a>
   ...
   <?php 
            ...
            echo   form_open('galery/proses_update_galery', $data);
            ?>
...
<?php 
         $gambar    = array(
            ...
            echo form_hidden('waktu',namahari($nohari).' '.$tgl.' '.namabulan($bln).' '.$thn);
                  echo form_hidden('id_galery',$edit->id_galery);
            echo img('asset/upload/galery/gambarkecil/'.$edit->gambar_kecil_gal);
              echo form_hidden('g_besar', $edit->gambar_besar_gal);
              echo form_hidden('g_kecil', $edit->gambar_kecil_gal);
...
echo form_textarea('ket_foto',$edit->ket_galery);
