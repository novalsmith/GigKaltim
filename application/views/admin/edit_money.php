...
<i class="icon  icon-arrow-left icon-white"></i> Kembali</a>
   ...
   <?php 
            ...
            echo   form_open('money/proses_update_money', $data);
            ?>
...
<?php 
         ...
         echo form_hidden('id_money',$edit->id_money);
            echo img('asset/upload/money/gambarkecil/'.$edit->gambar_kecil_money);
              echo form_hidden('g_besar', $edit->gambar_besar_money);
              echo form_hidden('g_kecil', $edit->gambar_kecil_money);
...
echo form_textarea('ket_money',$edit->ket_money);
