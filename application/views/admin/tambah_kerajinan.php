<h3 style="border-bottom:dashed 1px #AAB2BD">Tambah Kerajinan Khas Baru
<small>
...
<i class="icon  icon-arrow-left icon-white"></i> Kembali</a>
   ...
   <?php 
            ...
            echo   form_open('Kerajinan/proses_tambah_kerajinan', $data);
            ?>
...
echo form_textarea('ket_kerajinan');
