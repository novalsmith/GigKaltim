<h3 style="border-bottom:dashed 1px #AAB2BD">Tambah Tour Travel Baru
<small>
...
<i class="icon  icon-arrow-left icon-white"></i> Kembali</a>
   ...
   <?php 
            ...
            echo   form_open('tour_travel/proses_tambah_tour_travel', $data);
            ?>
...
echo form_textarea('ket_tour_travel');
