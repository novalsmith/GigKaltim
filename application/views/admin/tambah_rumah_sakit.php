<h3 style="border-bottom:dashed 1px #AAB2BD">Tambah Rumah Sakit Baru
<small>
...
<i class="icon  icon-arrow-left icon-white"></i> Kembali</a>
   ...
   <?php 
            ...
            echo   form_open('rumah_sakit/proses_tambah_rumah_sakit', $data);
            ?>
...
echo form_textarea('ket_rumah_sakit');
