<style type="text/css" media="screen">
	body
	{
		background-image: url(<?=base_url().'asset/img/hotairballoons7.jpg' ?>);
	}
	#user
	{
		height: 30px;
...
<button type="submit" class="btn btn-primary"><i class="icon icon-white  icon-user"></i> Login Masuk</button>
